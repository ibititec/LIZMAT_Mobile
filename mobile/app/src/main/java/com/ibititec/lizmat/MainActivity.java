...
import com.ibititec.lizmat.helpers.JsonHelper;
import com.ibititec.lizmat.noticia.FeedNoticiasActivity;
import com.ibititec.lizmat.util.RegistrationIntentService;
...
public class MainActivity extends AppCompatActivity
    ...
    //CONSTANTES NOME DO JSON NA BASE DE DADOS
    public static final String PDARTILHARIA = "pdartilharia_lizmat", PDTABELA = "pdtabela_lizmat", PDCLASSIFICACAO = "pdclassificacao_lizmat",
            SDARTILHARIA = "sdartilharia_lizmat", SDTABELA = "dstabela_lizmat", SDCLASSIFICACAO = "sdclassificacao_lizmat",
            PDCLASSIFICACAOBOLAO = "pdclassificacaobolao_lizmat", SDCLASSIFICACAOBOLAO = "sdclassificacaobolao_lizmat",
            PDJOGOSBOLAO = "pdjogosbolao_lizmat", SDJOGOSBOLAO = "sdjogosbolao_lizmat", USUARIO = "usuario_lizmat", PDJOGOSRODADA = "pdjogosRODADA_lizmat", SDJOGOSRODADA = "sdjogosRODADA_lizmat";


    public static final String TAG = "LIZMAT";
    public static final String PATH_FOTOS = "http://52.37.37.207:97/Campeonato/Image?nomeimagem=";
