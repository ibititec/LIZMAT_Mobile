package com.ibititec.lizmat.modelo;
...
public class Bolao implements Serializable {
    ...
    public com.ibititec.lizmat.modelo.Usuario getUsuario() {
        return Usuario;
    }

    public void setUsuario(com.ibititec.lizmat.modelo.Usuario usuario) {
        Usuario = usuario;
    }

    public com.ibititec.lizmat.modelo.Partida getPartida() {
        return Partida;
    }

    public void setPartida(com.ibititec.lizmat.modelo.Partida partida) {
        Partida = partida;
    }
